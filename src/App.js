...
export default class App extends Component {
  ...
  apiKey ="6bb8f24355e9481fb860981d699c113f"
  state = {
    progress : 0
  }
    ...
    return (
      <div>
          ...
          <Routes>
            ...
            <Route path="/general" element={<News setProgress={this.setProgress} apiKey={this.apiKey} key="general" pageSize = {20} country='in' category='general'/>}/>
